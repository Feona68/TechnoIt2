    ...
    <div className={darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}>
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl">Privacy & Policy</h1>
          <p className="text-lg mt-2 sm:text-xl md:text-2xl">Lorem ipsum dolor sit amet consectetur adipiscing elit</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 md:px-8">
        {/* First Section */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-4 sm:text-4xl md:text-4xl">Introduction</h2>
        ...
        {/* Second Section */}
        <div>
          <h2 className="text-3xl font-bold mb-4 sm:text-4xl md:text-4xl">Data Protection</h2>
          <p className="text-lg sm:text-xl md:text-1xl">
      ...
      {/* Footer */}
      <footer
        className={`py-6 text-center sm:py-8 md:py-10 ${
          darkMode ? "bg-gray-800 text-white" : "bg-white text-black border-t border-gray-300"
        }`}
      >
        <p className="text-lg sm:text-xl md:text-2xl">© 2025 Your Company. All rights reserved.</p>
      </footer>
    </div>
  );
};
